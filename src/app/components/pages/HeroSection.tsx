  ...
  return (
    ...
    >
      ...
      <img
        ...
        style={{
          right: '5%', bottom: '8%', width: '68%', maxWidth: '980px', minWidth: '420px',
          height: 'auto', maxHeight: '92vh', objectFit: 'contain', objectPosition: 'bottom right',
          opacity: 0.9,
      ...
      <div className="relative z-10 flex items-start" style={{ minHeight: '100vh', paddingTop: '18vh' }}>
        <div className="max-w-6xl mx-auto w-full px-8">
          ...
          >
            ...
            {/* Buttons + cortex side by side, centered vertically */}
            <div className="flex flex-row items-center gap-4 mb-7">
              {/* Left col: buttons + review */}
              <motion.div
              ...
              >
                ...
                >
                  ...
                  <p className="text-white/55 italic" style={{ fontSize: '0.82rem' }}>"Not human. Better"</p>
              ...
              {/* Cortex image — no effect on surrounding layout */}
              <img
