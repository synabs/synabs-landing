      ...
      >
        <div className="max-w-2xl mx-auto w-full">
          ...
          >
            ...
            {isCustom ? (
              <>
                {/* Price row — identical structure to regular, number hidden, dash overlaid */}
                <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: 40 }}>
                  <div>
                    <div style={{ display: 'flex', alignItems: 'baseline', gap: 4, position: 'relative' }}>
                      <span style={{ fontSize: 72, fontWeight: 200, color: 'transparent', letterSpacing: -3, lineHeight: 0.9, userSelect: 'none' }}>699</span>
                      <span style={{ fontSize: 22, color: 'transparent', fontWeight: 300, paddingBottom: 4, userSelect: 'none' }}>€</span>
                      <span style={{ position: 'absolute', left: 0, top: 0, bottom: 0, display: 'flex', alignItems: 'center', fontSize: 40, fontWeight: 200, color: c.text, lineHeight: 1 }}>—</span>
                    </div>
                  ...
                  <div style={{ textAlign: 'right', paddingBottom: 4 }}>
                    ...
                    <p style={{ color: c.faint, fontSize: 12, margin: 0, fontWeight: 300 }}>+€0.06 / message</p>
                  </div>
                </div>
